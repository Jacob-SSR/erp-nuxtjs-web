  ...
  >
    <div class="w-full max-w-lg">
      ...
      >
        ...
        <button
          class="btn bg-white text-gray-900 border-2 border-gray-300 shadow-none px-2 py-1 cursor-pointer"
          @click="closeModal"
        >
      ...
      <div
        class="modal-body bg-white p-4 rounded-bl-xl rounded-br-xl shadow-lg"
      >
        <slot />
      </div>
    </div>
